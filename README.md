...
В рамках тестового был детально проработан модуль `pipeline_anomaly`: расширен пайплайн, добавлены источники/алертинг и покрытие ключевых use-case'ов тестами.
